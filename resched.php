...
<body>
    <div class="bar">
        ...
        <h1 class="pageTitle">Re-Schedule Interview Request</h1>
...
<div class="applicantTable">
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM reschedule_requests";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><button class="scheduleBTN" onclick="openModal(this)">Schedule</button></td>';
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='7'>No reschedule requests.</td></tr>";
                }
                ?>
            </tbody>
        </table>
